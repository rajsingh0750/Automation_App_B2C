...
#    And user see the status as paid
    ...
    # removed infinite loop and using one scroll 6
...
#  #changes done
  ...
  #  #changes done   , have difference of 0.1 sometimes
  ...
  Scenario: Validate if the percentage change shown under Overview is correct for Total P&L
    ...
    # percentage text not available on inspector
